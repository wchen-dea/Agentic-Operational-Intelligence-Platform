...
# ---------------------------------------------------------------------------
from ai_layer.context import SessionMemory, StreamingStateStore, HybridContextAssembler
...
def test_mcp_server_importable():
    ...
    import services.mcp_server  # noqa: F401
...
# ---------------------------------------------------------------------------
from ai_layer.model_router import (
    ModelRouter,
    TaskComplexity,
    ModelSpec,
    get_model_router,
