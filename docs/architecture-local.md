...
| `neo4j`                  | neo4j:5.23-community                          | 7474, 7687             | Graph database for store relationships        |
| `feast-server`           | custom (`container/feature-store/Dockerfile`) | 6566                   | Feast online feature server                   |
| `vector-indexer`         | custom (`container/vector-index/Dockerfile`)  | —                      | Qdrant index builder (one-shot)               |
...
| `neo4j_data`                                   | Graph nodes and relationships    |
