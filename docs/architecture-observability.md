...
| ADR                                                | Decision                                                                               | Status   |
| -------------------------------------------------- | -------------------------------------------------------------------------------------- | -------- |
| [ADR-022](adr/022-observability-llm-evaluation.md) | `MetricsCollector` + `LLMEvaluator` + `AgentPerformanceTracker` with Prometheus export | Accepted |
| [ADR-021](adr/021-token-cost-efficiency.md)        | Per-call `LLMUsage` tracking with session-level cost summaries                         | Accepted |
